...
public class VistaMaquinas extends JInternalFrame {

	private JTextField txtID;
	private JTextField txtNombre;
	private JButton btmGuardar;
	private Controller_maquinas ctlMaquina;
	/**
	 * Create the frame.
	 */
	public VistaMaquinas(String titulo) {
		...
		ctlMaquina = new Controller_maquinas(this);
		...
		JLabel lblNombre = new JLabel("Serial");
		...
		btmGuardar.addActionListener(ctlMaquina);
		panel.add(btmGuardar);
		getContentPane().setLayout(groupLayout);
		this.addInternalFrameListener(ctlMaquina);
