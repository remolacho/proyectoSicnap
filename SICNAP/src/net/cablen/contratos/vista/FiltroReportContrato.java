...
import net.cablen.contratos.controlador.Controller_filtro;

public class FiltroReportContrato extends JInternalFrame {
	...
	public FiltroReportContrato(String titulo) {
		...
		btmProveedor = new JButton("Promotor");
